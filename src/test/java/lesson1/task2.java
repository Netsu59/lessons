...
//        итоговый счёт и бонусные рубли расчитывались правильно.
        ...
        int minBonusSum = 1000;
        int balance = 100;
        int refillSum = 1100;
        int bonus = (refillSum > minBonusSum) ? refillSum / 100 : 0;
        int finalBalance = balance + refillSum + bonus;
        System.out.println("Сумма " + finalBalance + " Бонус " + bonus);
    }
}
